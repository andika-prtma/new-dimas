...
function getDepartment(){
		...
		$ch = curl_init('http://api.multifab.co.id/v1/department/all');
...
function getProfileDepartment($id){
		...
		$ch = curl_init('http://api.multifab.co.id/v1/department/profile/'.$id);
...
function getAllUser(){
		...
		$ch = curl_init('http://api.multifab.co.id/v1/employee/all');
